...
?>
	...
	<ul class="nav nav-tabs">
  		...
  		<li role="presentation" class="FormatBTN active"><a href="fwa.php">FWA y CH</a></li>
<?php
...
<div id="Cabecera">
	<span>REGISTRO <br><font color="blue">FWA y CLARO HOGAR</font></span>
	<br>
</div>
<br>
<div class='Container'>
	...
	<form class="form-inline" name='frmFWA' action="SaveFWA.php" method="post">
		...
		<div class="col-md-12">
				...
				<div class='col-md-12'>
					<label class="control-label" id='lblServicio' for="lstServicio">Tipo de Servicio:</label><br>
	    			<select id='lstServicio' class="form-control input-sm label-primary" name='lstServicio'>
				...
				<div class='col-md-2'>
	    			...
	    			<select id='lstAprobadoCIVS' class="form-control input-sm label-primary" name='lstAprobadoCIVS' onchange='CategoriaFWA();'>
						...
						<option>Averia/Portabilidad</option>
				...
				<div class='col-md-2'>
					...
					<input type="text" class="form-control" name="txtNumAproba" placeholder="#CIVS" id="txtNumAproba" maxlength="60" size="31">
				</div>
		...
		<div class="col-md-12">
				<div class='col-md-2'>
	    			...
	    			<select id='lstEquipo' class="form-control input-sm label-primary" name='lstEquipo'>
						<option>[Elegir uno]</option>
						<option>Modem DLink DWR 920V</option>
		...
		<div class="col-md-12">
				...
				<div class='col-md-2'>
	    			...
	    			<input type="text" class="form-control" name="txtCliente" id="txtCliente" placeholder="Cliente" maxlength="60" size="31">
				</div>
		...
		<div class="col-md-12">
				...
				<div class='col-md-2'>
					<label class="control-label" id='lblOsadia' for="txtNumOsadia">Osadia:</label><br>
					<input type="text" class="form-control" name="txtOsadia" placeholder="# Osadia" id="txtOsadia" maxlength="6" size="17">
				</div>
				...
				<div class='col-md-2'>
	    			...
	    			<input type="text" class="form-control" name="txtVendedor" id="txtVendedor" placeholder="Vendedor" maxlength="60" size="31" onkeypress="return valida(event,1);" >
				</div>
		...
		<div class="col-md-12">
				<div class='col-md-2'>
					<label class='control-label' id='LblVendedor' for="txtidVendedor">Cod. Vendedor:</label>
	    			<input type="text" class="form-control" name="txtidVendedor" id="txtidVendedor" placeholder="Cod.Vendedor" maxlength="30" size="17">
				</div>
				<div class='col-md-2'>
					<label class='control-label' id='LblVendedor' for="txtZipCode">Zip Code:</label>
	    			<input type="text" class="form-control" name="txtZipCode" id="txtZipCode" maxlength="30" size="17">
				</div>
		...
		<div class="col-md-12">
				...
				<div class='col-md-12'>
	    			...
	    			<textarea class="form-control" name="txtDirCliente" id="txtDirCliente" rows="2" cols="61" placeholder="FISICA"></textarea>
	    			<textarea class="form-control" name="txtDireccionPostal" id="txtDireccionPostal" rows="2" cols="61" placeholder="POSTAL"></textarea>
				</div>

				<div class='col-md-12'>
					<label class='control-label' id='LblCodVendedor' for="txtReferencia">Punto de Referencia:</label><br>
		    		<input type="text" class="form-control" name="txtReferencia" id="txtReferencia" maxlength="75" size="179">
				</div>
		...
		<div class="col-md-12">
				...
				<div class='col-md-2'>
	    			...
	    			<select id='lstPaquete' class="form-control input-sm label-primary" name='lstPaquete'>
						...
						<option>10MB + Ilimitado 100GB + VOZ</option>
						<option>10MB + Ilimitado 150GB + VOZ</option>
						<option>10MB + Ilimitado 300GB PUJ + VOZ</option>
						<option disabled="yes">Solo Internet</option>
						<option>10MB + Ilimitado 100GB</option>
						<option>10MB + Ilimitado 150GB</option>
						<option>10MB + Ilimitado 300GB</option>
						<option disabled="yes">Claro Hogar</option>
						<option>VOZ en PR y LD a USA $19.99</option>
						<option>VOZ + DATA $29.99</option>
		...
		<div class="col-md-12">
				...
				<div class='col-md-2'>
	    			...
	    			<input type="text" class="form-control" name="txtRazon" id="txtRazon" placeholder="Razon de no completa" maxlength="75" size="179">
				</div>
