...
<div id="Cabecera">
	<span>Registro de Emisiones</span>
	<br>
	<br>
</div>
	...
	<form class="form-inline" name='frmEmisiones' action="SaveEmision.php" method="post">
		...
		<div class='Form-group has-success'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtOsadia" id="txtOsadia" placeholder="OSADIA" maxlength="6" size="6" onkeypress="return valida(event,3);" onblur="BuscarEmision();">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtCodeVender" id="txtCodeVender" placeholder="Ej: 00000" maxlength="6" size="6" onkeypress="return valida(event,3);" >
			</div>
		</div>
		<br>
		<br>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtTracker" id="txtTracker" placeholder="No. AAV" maxlength="13" size="13" onkeypress="return valida(event,3);">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtCops" id="txtCops" placeholder="COPS" maxlength="6" size="6" onkeypress="return valida(event,3);">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtM6" id="txtM6" value='00000000' placeholder="M6" maxlength="8" size="8" onkeypress="return valida(event,3);">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div id='ContEstado' class='col-md-12 MACOPEN'>
    			...
    			<input type="text" class="form-control" name="txtMAC" id="txtMAC" placeholder="MAC" maxlength="2" size="2" onkeypress="return valida(event,3);">
			</div>
		</div>
		<br>
		<br>
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class="control-label" id='lblEstado' for="LstEstado">Estado de la Emision:</label>
    			<select id='LstEstado' class="form-control input-sm label-primary" name='LstEstado' onchange="ShowMAC();">
					<option>Correcta</option>
					<option>No Emitida</option>
					<option>Failed</option>
					<option>Verificacion de Disponibilidad</option>
					<option>Verificacion de Deuda</option>
					<option>Processing</option>
					<option>Autorizado Gerente INV</option>
					<option>Transferencia</option>
					<option>Llamada Muda</option>
					<option>Se brinda Informacion</option>
					<option>Caso Referido</option>
					<option>Status Referido</option>
					<option>Otros</option>
    			</select>
			</div>
		</div>
		...
		<div class='Form-group'>
			<div id='DROPDOWN_DEUDA' class='DROP_DEUDA_HIDE'>
				<div class='col-md-12'>
					<label class="control-label" id='lblDeuda' for="LstDeuda">Situacion:</label>
	    			<select id='LstDeuda' class="form-control input-sm label-primary" name='LstDeuda' onchange="ShowMAC();">
						<option>...</option>
						<option>Cliente con deuda</option>
						<option>Cliente con orden cancelada</option>
	    			</select>
				</div>
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class="control-label" id='TitleEmision' for="txtTipoEmision">Tipo de emisión:</label>
    			<select id='LstTipoEmision' class="form-control input-sm label-primary" name='LstTipoEmision' onchange="ShowTipoEmision();" >
    				<option>N/A</option>
					<option>2Play</option>
					<option>Linea Sencilla</option>
					<option>IPTV Standallone</option>
					<option>Internet Standallone</option>
					<option>DISH Standallone</option>
					<option>3Play/IPTV</option>
					<option>3Play/DISH</option>
					<option>Portabilidad</option>
					<option>Claro Hogar</option>
    			</select>
			</div>
		</div>
		<br>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtDirCliente" id="txtDirCliente" placeholder="Direccion Cliente" maxlength="300" size="110">
			</div>
		</div>
		<br>
		<br>

		<div id='MarcoDeuda' class='MARCO_DEUDA_HIDE'>
			
		
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblFechaCancelacion' for="txtFechaCancelacion">Fecha Cancelación:</label>
    			<input type="date" class="form-control" name="txtFechaCancelacion" id="txtFechaCancelacion" placeholder="Fecha Cancelacion" maxlength="13" size="13">
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblDeudaCancelacion' for="txtDeudaCancelacion">Monto Deuda:</label>
    			<input type="text" class="form-control" name="txtMontoDeuda" id="txtMontoDeuda" placeholder="$0.00" maxlength="7" size="7" value='$0.00'>
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblPagoRealizado' for="txtPagoRealizado">Pago Realizado:</label>
    			<input type="text" class="form-control" name="txtPagoRealizado" id="txtPagoRealizado" placeholder="$0.00" maxlength="7" size="7" value='$0.00'>
			</div>
		</div>
		<br>
		<br>
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblBalancePendiente' for="txtBalancePendiente">Balance Pendiente:</label>
    			<input type="text" class="form-control" name="txtBalancePendiente" id="txtBalancePendiente" placeholder="$0.00" maxlength="7" size="7" value='$0.00'>
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblFechaPago' for="txtFechaPago">Fecha del Pago:</label>
    			<input type="date" class="form-control" name="txtFechaPago" id="txtFechaPago" maxlength="13" size="13">
			</div>
		</div>
		...
		<div id='MarcoAutorizada' class='MARCO_AUTO_HIDE'>
			
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblOrdenCancelada' for="txtOrdenCancelada">Orden Cancelada:</label>
    			<input type="text" class="form-control" name="txtOrdenCancelada" id="txtOrdenCancelada" placeholder="ORDEN CANCEL" maxlength="6" size="6">
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblRazonCancelada' for="txtRazonCancelada">Razón:</label>
    			<input type="text" class="form-control" name="txtRazonCancelada" id="txtRazonCancelada" placeholder="RAZON CANCELACION" maxlength="50" size="40">
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblFechaAutorizacion' for="txtFechaAutorizacion">Fecha:</label>
    			<input type="date" class="form-control" name="txtFechaAutorizacion" id="txtFechaAutorizacion"  />
			</div>
		</div>
				<br>
						<br>
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblContacto1' for="txtContacto1">Contactos:</label>
    			<input type="text" class="form-control" placeholder='Contacto 1' name="txtContacto1" id="txtContacto1" maxlength="13" size="13"/>
    			<input type="text" class="form-control" placeholder='Contacto 2' name="txtContacto2" id="txtContacto2" maxlength="13" size="13" />
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblComentarios' for="txtRazonCancelada">Notas:</label>
    			<input type="text" class="form-control" name="txtNotas" id="txtNotas" maxlength="1000" size="56">
			</div>
		</div>

		</div>

		<div id='MarcoClaroHogar' class='MARCO_AUTO_HIDE_HOGAR'>
		<center>
		<span style="font-size: 16px; color: black; font-weight: bold;">Preparando datos de envio Claro Hogar</span>
		</center>
		<br>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtCliente" id="txtCliente" placeholder="Cliente" maxlength="60" size="35">
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='lblID' for="txtIdentificacion">ID:</label>
    			<input type="text" class="form-control" name="txtIdentificacion" id="txtIdentificacion" placeholder="Identificacion" maxlength="60" size="13">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblContacto1' for="txtContactoHogar1">Contactos:</label>
    			<input type="text" class="form-control" placeholder='Contacto 1' name="txtContactoHogar1" id="txtContactoHogar1" maxlength="13" size="13"/>
    			<input type="text" class="form-control" placeholder='Contacto 2' name="txtContactoHogar2" id="txtContactoHogar2" maxlength="13" size="13" />
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblCodVendedor' for="txtPueblo">Pueblo:</label>
	    		<input type="text" class="form-control" name="txtPueblo" id="txtPueblo" maxlength="25" size="18">
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblCodVendedor' for="txtZipCode">ZipCode:</label>
	    		<input type="text" class="form-control" name="txtZipCode" id="txtZipCode" maxlength="15" size="10">
			</div>
		</div>

		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblCodVendedor' for="txtFechaVenta">Fecha Venta:</label>
	    		<input type="date" class="form-control" name="txtFechaVenta" id="txtFechaVenta"  maxlength="10" size="10">
			</div>
		</div>
		<br>
		<br>
