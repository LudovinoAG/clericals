...
<div class='Container'>
	...
	<form class="form-inline" name='frmFWA' action="SaveFWA.php" method="post">
			...
			<div class='Form-group'>
				<div class='col-md-12'>
					<label class="control-label" id='lblEstado' for="lstAprobadoCIVS">Aprobado CIVS?:</label>
			...
			<div class='Form-group'>
				<div class='col-md-12'>
					...
					<input type="text" class="form-control" name="txtNumAproba" placeholder="#CIVS" id="txtNumAproba" maxlength="60" size="29">
				</div>
			</div>
			...
			<div class='Form-group has-success'>
				<div class='col-md-12'>
		    		...
		    		<input type="text" class="form-control" name="txtBan" id="txtBan" placeholder="#BAN" maxlength="10" size="19">
				</div>
			</div>
			...
			<div class='Form-group'>
				<div class='col-md-12'>
					...
					<input type="text" class="form-control" name="txtTipoPago" placeholder="Tipo de Pagos" id="txtTipoPago" maxlength="60" size="40">
				</div>
			</div>

			<div class='Form-group'>
				<div class='col-md-12'>
					<label class='control-label' id='lblTitleTracker' for="txtMonto">Monto$:</label>
    			<input type="text" class="form-control" name="txtMonto" id="txtMonto" placeholder="Monto$" maxlength="6" size="6" onkeypress="return valida(event,3);">
				</div>
			</div>
			...
			<div class='Form-group'>
				<div class='col-md-12'>
					...
					<input type="text" class="form-control" name="txtConfirmacionSpy" id="txtConfirmacionSpy" placeholder="# Confirmacion de pago" maxlength="30" size="22" >
				</div>
			</div>
			...
			<div class='Form-group'>
				<div class='col-md-12'>
	    			...
	    			<input type="text" class="form-control" placeholder='Contacto 2' name="txtContactoHogar2" id="txtContactoHogar2" maxlength="10" size="10" />
				</div>
			</div>
			...
			<div class='Form-group'>
				<div class='col-md-12'>
	    			...
	    			<input type="text" class="form-control" name="txtCanal" id="txtCanal" placeholder="Ej: INVMT3" maxlength="25" size="10">
				</div>
			</div>
			...
			<div class='Form-group'>
				<div class='col-md-12'>
	    			...
	    			<input type="text" class="form-control" name="txtEmail" id="txtEmail" placeholder="Ej: cliente@claropr.com" maxlength="80" size="33">
				</div>
			</div>
			...
			<div class='Form-group'>
				<div class='col-md-12'>
	    			...
	    			<input type="text" class="form-control" name="txtVendedor" id="txtVendedor" placeholder="Vendedor" maxlength="60" size="29" onkeypress="return valida(event,1);" >
				</div>
			</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblDirCliente'>Direccion:</label>
    			<textarea class="form-control" name="txtDirCliente" id="txtDirCliente" rows="2" cols="55" placeholder="FISICA"></textarea>
    			<textarea class="form-control" name="txtDireccionPostal" id="txtDireccionPostal" rows="2" cols="54" placeholder="POSTAL"></textarea>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
	    		...
	    		<input type="text" class="form-control" name="txtReferencia" id="txtReferencia" maxlength="75" size="104">
			</div>
		</div>
		...
		<div class='Form-group'>
	    	...
	    	<input type="text" class="form-control" name="txtPersonaAutorizada" id="txtPersonaAutorizada" maxlength="60" size="58">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class="control-label" id='lblEstado' for="lstVentaCompletada">Venta Completada:</label>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='lblTitleTracker' for="txtRazon">Razon:</label>
    			<input type="text" class="form-control" name="txtRazon" id="txtRazon" placeholder="Razon no completa" maxlength="100" size="118" >
			</div>
		</div>
