...
<div class='Container FORM_DEMORA'>
	...
	<form class="form-inline" name='frmDemoras' action="SaveDemora.php" method="post">
		...
		<div class="row">
			...
			<div class='col-md-1 col-xs-12 FILA_LABEL'>
				<label class='control-label' id='lblTitleOsadia' for="txtTracker">OSADIA:</label>
			</div>

			<div class='col-md-1 col-xs-12 FILA_CAMPO'>
			...
			<div class='col-md-2 col-xs-12 FILA_LABEL'>
				<label class='control-label' id='LblCliente' for="txtCliente">Nombre Cliente:</label>
			</div>

			<div class='col-md-2 col-xs-12 FILA_CAMPO'>
			...
			<div class='col-md-4 col-xs-12 FILA_CAMPO'>
		...
		<div class="row">
			...
			<div id='ContEstado' class='col-md-2 col-xs-12 FILA_LABEL'>
				<label class='control-label' id='lblTitleMAC' for="txtMACActual">MAC:</label>
			</div>

			<div id='ContEstado' class='col-md-3 col-xs-12 FILA_CAMPO'>
		...
		<div class="row">
			...
			<div class='col-md-3 col-xs-12 FILA_CAMPO'>
		...
		<div class='row'>
			...
			<div class='col-md-10 col-xs-12 FILA_CAMPO'>
    			<textarea class="form-control" name="txtNotas" id="txtNotas" rows="4" cols="124" maxlength="2500"></textarea>
			</div>
		</div>
		...
		<div class='row'>
    		...
    		<div class="input-group">
			      <span class="input-group">
			      	<label for="CHKGPON">
			        	<input type="checkbox" name="CHKGPON" aria-label="...">GPON
			        </label>
			      </span>
			</div>
		</div>
