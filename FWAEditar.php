...
<div class='Container'>
	...
	<form class="form-inline" name='frmFWA' action="SaveEditarFWA.php" method="post">
		...
		<div class="col-md-12">
			...
			<?php
				if($conexion = mysqli_connect('127.0.0.1','root','123456')){
					...
					$sql = "SELECT * FROM ventasfwa where id='$ID'";
					$resultado = mysqli_query($conexion, $sql) or die ('No ejecutado');
					$filaFWA=mysqli_fetch_row($resultado);
			...
			?>
				...
				<div class='col-md-2'>
	    			...
	    			<select id='lstAprobadoCIVS' class="form-control input-sm label-primary" name='lstAprobadoCIVS' onchange='CategoriaFWA();'>
						<option><?php echo $filaFWA[5];  ?></option>
