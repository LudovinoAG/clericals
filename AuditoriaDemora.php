...
<table class="table">
	<tr class="Fila_Contadores">
		...
		?>
				...
				<td class="FILA_COUNT"><a style="color: white;" href="TodasAuditadas.php" data-toggle="tooltip" data-placement="top" title="Ver auditorias">
...
<?php
        if($_SESSION["Perfil"]=='11'){
          ...
          echo "<li role='presentation' class='FormatBTN active'><a href='AuditoriaDemora.php'>Auditar demoras</a></li>";
        }
  ...
  <table class="table text-center table-hover">
		...
		<?php
			if($conexion = mysqli_connect('127.0.0.1','root','123456')){
					...
					$Usuario = $_SESSION['Tarjeta'];
					$FECHA = date('n/j/Y');
					$sql = "SELECT * FROM auditdemora WHERE FechaDemora='$FECHA' AND Auditada='0' ORDER BY Resultado ASC";
