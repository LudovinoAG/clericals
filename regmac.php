...
<br>
<div id="Cabecera">
	<span>Registros de seguimiento MAC </span>
	<br>
</div>
<br>
...
<div class='Container'>
	...
	<form class="form-inline" name='frmMac' action="savemac.php" method="post">
	<input type="text" name="txtCrono" id="Cronometro" hidden="true" />
		<div id='Div_OrdenOS' class='Form-group has-success'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtOrdenOS" id="txtOrdenOS" placeholder="Osadia" maxlength="6" size="6" onkeypress="return valida(event,3);" onblur="BuscarOS();" >
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtCanal" id="txtCanal" placeholder="Canal" maxlength="10" size="10">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name='txtCliente' id="txtCliente" placeholder="Nombre completo" size="37" maxlength="35" onkeypress="return valida(event,1);">
			</div>
		</div>
		<br>
		<br>
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtMacActual" id="txtMacActual" placeholder="MAC" maxlength="2" size="2" onkeypress="return valida(event,3);">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtMacFinal" id="txtMacFinal" placeholder="MAC" maxlength="2" size="2" onkeypress="return valida(event,3);">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class="control-label" id='LblIntento' for="LstIntento">Intentos:</label>
    			<select id='LstIntento' class="form-control input-sm" name='LstIntento'>
    				<option>1er</option>
    				<option>2do</option>
    				<option>3er</option>
    			</select>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" id="txtContactos1" placeholder="Contacto 1" size="12" maxlength="10" name='txtContactos1' onkeypress="return valida(event,3);">
    			<input type="text" class="form-control" id="txtContactos2" placeholder="Contacto 2" size="12" maxlength="10" name='txtContactos2' onkeypress="return valida(event,3);"> 
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<textarea class='form-control' id='txtNotas' Name='TxtNotas' cols="108" rows="3"></textarea>
			</div>
		</div>
		<br>
		<br>
		...
		<div class='col-md-6 text-center' id='BthBotones'>
			<button type='button' class='btn btn-primary' id='bthAgregar' name='bthAgregar' onclick='Send();'>
    			<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Añadir
    		</button>
 
    		<button type='button' class='btn btn-danger' id='bthClear' name='bthClear'>
