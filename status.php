	...
	<form class="form-inline" name='frmStatus' action="SaveStatus.php" method="post">
		...
		<div class='Form-group has-success'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtOsadia" id="txtOsadia" placeholder="OSADIA" maxlength="6" size="6" onkeypress="return valida(event,3);">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtCodeVender" id="txtCodeVender" placeholder="Ej: 00000" maxlength="6" size="6"" >
			</div>
		</div>
		<br>
		<br>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class='control-label' id='LblNombreCliente' for="txtCliente">Contactos:</label>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<input type="text" class="form-control" name="txtCodeVenderCanal" id="txtCodeVenderCanal" placeholder="Ej: PR" maxlength="15" size="18">
			</div>
		</div>
		...
		<div class='Form-group'>
			<div id='ContEstado' class='col-md-12'>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<select id='LstEstado' class="form-control input-sm label-primary" name='LstEstado'>
					...
					<option>Retenida</option>
					<option>Re-Emitida</option>
    			</select>
			</div>
		</div>
				<br>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
				<label class="control-label" id='lblretencionstatus' for="LstRetencionStatus">Se le hizo Retención?:</label>
    			<select id='LstRetencionStatus' class="form-control input-sm label-primary" name='LstRetencionStatus'>
		...
		<div class='Form-group'>
			<div class='col-md-12'>
    			...
    			<textarea class="form-control" name="txtNotas" id="txtNotas" rows="4" cols="100"></textarea>
			</div>
		</div>
