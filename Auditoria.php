...
<html>
<head>
	<title>DATA Clericals - Auditoria de Emisiones</title>
	<meta charset='utf-8' />
...
<br>
<div id="Cabecera">
	<span>Auditoria de Emisiones</span>
	<br>
	<br>
</div>
...
<div class="table-responsive">
  <table class="table text-center table-hover">
		...
		<tr class='success'>
		  ...
		  <td class='Encabezado'>Tarjeta</td>
		  <td class='Encabezado'>Agente</td>
		  ...
		  <td class='Encabezado'>Auditada</td>
		  <td class='Encabezado'>Observación</td>
		</tr>
		...
		<?php
			if($conexion = mysqli_connect('127.0.0.1','root','123456')){
					...
					$Usuario = $_SESSION['Tarjeta'];
					$FECHA = date('n/j/Y');
					$sql = "SELECT * FROM emisiones WHERE Fecha='$FECHA' ORDER BY Representante ASC";
					...
					while($RegAgent=mysqli_fetch_array($result))
						{
							...
							echo "<tr id='filasData'>
									<td><a href='updatemision.php?ID=$RegAgent[0]'><button class='btn btn-info btn-lg'><span class='glyphicon glyphicon-pencil'></span></button></a></td>
									<td>$RegAgent[1]</td>
									<td>$RegAgent[2]</td>
									<td>$RegAgent[10]</td>
									<td>$RegAgent[4]</td>
