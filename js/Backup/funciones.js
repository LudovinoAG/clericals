...
function ShowEmisionSub(){
	...
	if(SubRazonEmision.value=='Orden Emitida'){
		...
		||	SubRazonEmision.value=='Finanzas' || SubRazonEmision.value=='Llamada al area equivocada' ){
...
function ShowEmision(){
	...
	"Cliente no desea servicio", "TPV rechazado", "Pendiente info. cliente", "Llamada se cae en proceso", "No Cobertura"];
	...
	var SubCategoriaRazonInformacion= ["[Elegir una..]", "Confirmacion de Pago", "Efectuar Pago", "Llamada al area equivocada"];
	...
	if(RazonEmision.value=='Emisión'){
			...
			for(var i=0;i<SubCategoriaRazonInformacion.length;i++){
	  		...
	  		Osadia.value = Math.round(Math.random()*999999);
	  		txtVendedor.value = "N/A";
			txtCodeVender.value = "N/A";
			txtTeam.value = "N/A";
			txtCodeVenderCanal.value = "N/A";
			txtTracker.value = "N/A";
			txtCops.value = "N/A";
			txtM6.value = "N/A";
			txtMAC.value = "N/A";
			txtDirCliente.value = "N/A";
